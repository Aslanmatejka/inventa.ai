...
metadata = ExampleMetadata(
    ...
    name="Glock 34",
    category="firearm",
    keywords=["glock", "glock 34", "g34", "competition", "long slide", "9mm", "tactical", "firearm", "handgun", "pistol"],
    description="Stylized prop of the Glock 34: competition long-slide 9mm with front serrations.",
    techniques=["boolean_union", "boolean_cut", "guarded_fillet"],
    nominal_dimensions_mm={"length": 222.0, "height": 138.0, "width": 32.5},
    difficulty="medium",
)
...
# Lightening cut on top of long slide
light = (cq.Workplane("XY").workplane(offset=GRIP_H + SLIDE_H - 2)
         .center(SLIDE_LEN * 0.55, 0).rect(SLIDE_LEN * 0.3, 8).extrude(4))
slide = slide.cut(light)
