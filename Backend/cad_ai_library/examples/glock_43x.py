...
metadata = ExampleMetadata(
    ...
    name="Glock 43X",
    category="firearm",
    keywords=["glock", "glock 43x", "g43x", "slimline", "9mm", "single-stack", "ten-round", "concealed carry", "firearm", "handgun", "pistol"],
    description="Stylized prop of the Glock 43X: slimline 9mm with longer grip for 10-round magazine.",
    techniques=["boolean_union", "boolean_cut", "guarded_fillet"],
    nominal_dimensions_mm={"length": 165.0, "height": 127.0, "width": 22.0},
    difficulty="medium",
)
