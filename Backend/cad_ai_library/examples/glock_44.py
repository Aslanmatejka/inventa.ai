...
metadata = ExampleMetadata(
    ...
    name="Glock 44",
    category="firearm",
    keywords=["glock", "glock 44", "g44", "rimfire", ".22", "22 lr", "22lr", "training", "firearm", "handgun", "pistol"],
    description="Stylized prop of the Glock 44: .22 LR rimfire trainer with G19-sized frame.",
