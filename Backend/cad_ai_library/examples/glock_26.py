...
metadata = ExampleMetadata(
    ...
    name="Glock 26",
    category="firearm",
    keywords=["glock", "glock 26", "g26", "subcompact", "baby glock", "9mm", "concealed carry", "firearm", "handgun", "pistol"],
    description="Stylized prop of the Glock 26: subcompact 9mm 'Baby Glock' — short slide, short grip.",
    techniques=["boolean_union", "boolean_cut", "guarded_fillet"],
    nominal_dimensions_mm={"length": 165.0, "height": 106.0, "width": 32.5},
    difficulty="medium",
)
