...
metadata = ExampleMetadata(
    ...
    name="Glock 42",
    category="firearm",
    keywords=["glock", "glock 42", "g42", "subcompact", ".380", "380 acp", "single-stack", "slimline", "pocket", "firearm", "handgun", "pistol"],
    description="Stylized prop of the Glock 42: subcompact single-stack .380 ACP — Glock's smallest pistol.",
    techniques=["boolean_union", "boolean_cut", "guarded_fillet"],
    nominal_dimensions_mm={"length": 151.0, "height": 105.0, "width": 24.0},
    difficulty="medium",
)
