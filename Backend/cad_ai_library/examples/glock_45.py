...
metadata = ExampleMetadata(
    ...
    name="Glock 45",
    category="firearm",
    keywords=["glock", "glock 45", "g45", "crossover", "9mm", "compact slide", "full-size grip", "firearm", "handgun", "pistol"],
    description="Stylized prop of the Glock 45: compact G19 slide on a full-size G17 grip, with front serrations.",
    techniques=["boolean_union", "boolean_cut", "guarded_fillet"],
    nominal_dimensions_mm={"length": 189.0, "height": 139.0, "width": 32.5},
    difficulty="medium",
)
