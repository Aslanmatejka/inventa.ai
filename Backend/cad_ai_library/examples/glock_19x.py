...
metadata = ExampleMetadata(
    ...
    name="Glock 19X",
    category="firearm",
    keywords=["glock", "glock 19x", "g19x", "crossover", "9mm", "coyote", "striker-fired", "firearm", "handgun", "pistol"],
    description="Stylized prop of the Glock 19X: crossover pistol with compact G19 slide on a full-size G17 grip.",
