...
metadata = ExampleMetadata(
    ...
    name="Glock 19",
    category="firearm",
    keywords=["glock", "glock 19", "g19", "compact", "9mm", "concealed carry", "striker-fired", "firearm", "handgun", "pistol"],
    description="Stylized prop of the Glock 19: compact 9mm, the most popular Glock size.",
    techniques=["boolean_union", "boolean_cut", "guarded_fillet"],
    nominal_dimensions_mm={"length": 187.0, "height": 128.0, "width": 32.5},
    difficulty="medium",
)
