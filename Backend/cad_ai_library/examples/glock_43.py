...
metadata = ExampleMetadata(
    ...
    name="Glock 43",
    category="firearm",
    keywords=["glock", "glock 43", "g43", "single-stack", "slimline", "9mm", "concealed carry", "firearm", "handgun", "pistol"],
    description="Stylized prop of the Glock 43: slimline single-stack 9mm concealed-carry pistol.",
    techniques=["boolean_union", "boolean_cut", "guarded_fillet"],
    nominal_dimensions_mm={"length": 159.0, "height": 108.0, "width": 22.0},
    difficulty="medium",
)
